...
public class Video implements Serializable, Parcelable
{
    ...
    public final static Parcelable.Creator<Video> CREATOR = new Creator<Video>() {
        ...
        public Video[] newArray(int size) {
            ...
            ;
    private final static long serialVersionUID = 598775686244020405L;
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(id).append(iso6391).append(iso31661).append(key).append(name).append(site).append(size).append(type).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(id, rhs.id).append(iso6391, rhs.iso6391).append(iso31661, rhs.iso31661).append(key, rhs.key).append(name, rhs.name).append(site, rhs.site).append(size, rhs.size).append(type, rhs.type).isEquals();
    }
